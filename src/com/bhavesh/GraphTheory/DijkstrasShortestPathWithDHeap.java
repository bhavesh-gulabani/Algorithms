...
public class DijkstrasShortestPathWithDHeap {
    ...
    // from a starting node ti an ending node. If there is no path between the
        ...
        while (!ipq.isEmpty()) {
            ...
            for (Edge edge : edges) {
                ...
                if (newDist < dist[edge.to]) {
                    ...
                    // Insert the cost of going to a node for the first time in PQ,
            ...
            // Once we've processed the end node we can return early because
            // we know we cannot get a shorter path by routing through any other
            // nodes since Dijkstra's is greedy and there are no negative edge weights
