/*
 * An implementation of Dijkstra's shortest path algorithm from a start node to a
...
public class DijkstrasShortestPath {
    ...
    // Small epsilon value for comparing double values
    ...
    public DijkstrasShortestPath(int n, Comparator<Node> comparator) {
        this(n);
    ...
    public double dijkstra(int start, int end) {
        ...
        // Maintain an array of minimum distance to each node
        dist = new double[n];
        ...
        while (!pq.isEmpty()) {
            ...
            for (Edge edge : edges) {
                ...
                // Relax the edge by updating minimum cost if applicable
            ...
            // Once we've visited all the nodes spanning from the end node
            // we know we can return minimum distance value to the end node
            // because it cannot get any better after this point
