...
public class DoublyLinkedList<T> implements Iterable<T> {
    ...
    // Append an element to the linked list, O(1)
    ...
    // Add am element to the beginning of this linked lisr, O(1)
    ...
    public T removeFirst() {
        ...
        // Return the data that we just extracted
        return data;
    }
